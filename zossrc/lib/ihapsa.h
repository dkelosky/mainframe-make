#ifndef __CCSFIXH_PSA__
#define __CCSFIXH_PSA__
//  Generated by ccsfixh Version 1.5.5 on Mon Oct 14 11:53:33 2013
//      from CA90SMVS.METAL.ASMCHDR(IHAPSA)
...
struct psa {
  ...
  union {
    struct {
      struct cvt * __ptr32 _flccvt;      /* -    ADDRESS OF CVT (AFTER IPL).  THIS OFFSET    */
  ...
  union {
    struct {
      ...
      struct {
        ...
        struct cvt * __ptr32 _flccvt2;     /* -    ADDRESS OF CVT - USED BY DUMP               */
        } flccvt64;
  ...
  union {
    ...
    unsigned char  _flcesdata[4]; /* FLCE 88x: Additional SVC interruption data */
    struct {
      unsigned char  _flcesdatabyte0[2]; /* FLCE 88x: */
      unsigned char  _filler13[2];
      } _psa_struct3;
    struct {
  ...
  union {
    ...
    struct {
      unsigned char  _flcepdata[4]; /* FLCE 8Cx: Additional Program interruption */
      unsigned char  _filler17[4];
      } _psa_struct5;
    struct {
      unsigned char  _flcepdatabyte0[2]; /* FLCE 8Cx: */
      unsigned char  _filler18[6];
      } _psa_struct6;
    struct {
      unsigned char  _filler19;      /* FLCE 8Cx: Reserved                         */
      unsigned char  _flcepilc;      /* FLCE 8Dx: Program interruption length code */
      unsigned char  _flcepicode[2]; /* FLCE 8Ex: Program interruption code        */
      unsigned char  _filler20[4];
      } _psa_struct7;
    struct {
      unsigned char  _filler21[2];
      unsigned char  _flcepicode0;          /* FLCE 8Ex: Exception extension code */
      unsigned char  _flcepicode1;          /* FLCE 8Fx: 8-bit interruption code  */
      unsigned char  _flcepiinformation[4]; /* FLCE 90x:                          */
      } _psa_struct8;
    struct {
      unsigned char  _filler22[4];
      unsigned char  _filler23[3];
  ...
  union {
    ...
    unsigned char  _flcepercode[2]; /* FLCE 96x: PER code */
    struct {
  ...
  union {
    ...
    unsigned char  _flceper[8]; /* FLCE 98x: PER address */
    struct {
  ...
  union {
    void * __ptr32 _psampl;  /* -    MPL ADDRESS.  THIS OFFSET FIXED BY */
    void * __ptr32 _flcempl; /* FLCE A4x: MPL address                   */
    } _psa_union15;
  union {
    unsigned char  _flceteid[8];      /* FLCE A8x: Translation exception         */
    unsigned char  _flcetea[8];       /* FLCE A8x: Translation exception address */
    struct {
      unsigned char  _filler26[6];
      unsigned char  _flcetea6;     /* FLCE AEx: Byte 6 of FlceTEA */
      unsigned char  _flcetea7;     /* FLCE AFx: Byte 7 of FlceTEA */
      } _psa_struct15;
    unsigned char  _flceteasninfo[8]; /* FLCE A8x: ASN Info                      */
    struct {
      unsigned char  _filler27[6];
      short int      _flceteasn;    /* FLCE AEx: ASN */
      } _psa_struct16;
    unsigned char  _flcetepcinfo[8];  /* FLCE A8x: PC Info                       */
    struct {
      unsigned char  _filler28[4];
  ...
  union {
    struct {
      ...
      unsigned char  _filler29[6];  /* -      RESERVED                             @PPC */
      } flcfacl;
    unsigned char  _flcefacilitieslist[16]; /* FLCE C8x: Facilities list stored by STFLE. */
    struct {
  ...
  union {
    struct {
      unsigned char  _flcctsa[8]; /* -      CPU-TIMER SAVE AREA (FROM STORE-     @LHA */
      unsigned char  _flcccsa[8]; /* -      CLOCK-COMPARATOR SAVE AREA (FROM     @LHA */
      } _psa_struct20;
    unsigned char  _flcer0d8[16]; /* FLCE D8x: Reserved */
    } _psa_union19;
  union {
  ...
  union {
    struct {
      ...
      unsigned char  _filler30[4];  /* -      RESERVED - SET TO ZERO           @G860PXK    */
      } _psa_struct21;
  ...
  union {
    ...
    struct {
  void * __ptr64 _flceemfctrarrayaddr; /* FLCE 100x: The enhanced monitor facility */
  ...
  struct pcca * __ptr32 psapccav;                                /* -         VIRTUAL ADDRESS OF PCCA                      */
  void * __ptr32 psapccar;                                /* -         REAL ADDRESS OF PCCA                         */
  struct lcca * __ptr32 psalccav;                                /* -         VIRTUAL ADDRESS OF LCCA                      */
  void * __ptr32 psalccar;                                /* -         REAL ADDRESS OF LCCA                         */
  struct tcb * __ptr32 psatnew;                                 /* -         TCB pointer. Field maintained for code       */
  struct tcb * __ptr32 psatold;                                 /* -         Pointer to current TCB or zero if in SRB     */
  struct ascb * __ptr32 psaanew;                                 /* ASCB pointer.  Field maintained for code               */
  struct ascb * __ptr32 psaaold;                                 /* -         Pointer to the home (current) ASCB.          */
  struct {
  ...
  unsigned char  psarv22c[12];                            /* -     RESERVED                             @MCC        */
  union {
    unsigned char  _psa_workunit_procclassatdisp[2]; /* -                          @MCA */
    struct {
      unsigned char  _psa_workunit_procclassatdisp_byte0; /* @MCA */
      unsigned char  _psa_workunit_procclassatdisp_byte1; /* @MCA */
      } _psa_struct28;
    } _psa_union28;
  union {
    unsigned char  _psaprocclass[2];             /* -     PROCESSOR WUQ Offset.             */
    unsigned char  _psa_bylpar_procclass[2]; /* - PROCESSOR WUQ Offset.            @H5A */
    struct {
  ...
  unsigned char  psaicnt[8];                              /* -      Number of instructions executed at              */
  ...
  struct {
    struct {
      ...
      void * __ptr32 _psarvlk1; /* -         RESERVED FOR LOCK EXPANSION      @G860PXK */
  ...
  void * __ptr32 psalita;                                 /* -  ADDRESS OF LOCK INTERFACE TABLE.                    */
  ...
  unsigned char  psarv37e[2];                             /* -      RESERVED                             @PJC       */
  struct {
    struct {
  ...
  void * __ptr32 _filler31;                               /* -         MODEL PSW SECOND HALF  (MDC325)  @G50DP9A    */
  unsigned char  psasmpsw[4];                             /* - SRB DISPATCH PSW  (MDC326)      @G50DP9A             */
  void * __ptr32 _filler32;                               /* -         DISPATCH PSW SECOND HALF                     */
  ...
  union {
    ...
    struct {
      double         _filler33;    /* -           Part of PSAPSWSV16                   @M8C */
  ...
  struct {
    unsigned char  _filler34;  /* -      RESERVED - FIRST BYTE OF PSAMODEW         */
  ...
  unsigned char  _filler35[3];                            /* -      RESERVED                         @G860PXK       */
  ...
  struct {
    ...
    int            _filler36;  /* -         FULLWORD OF ZERO     (MDC612)    @G383P9A */
    } psadzero;
  ...
  unsigned char  psarv4d0[184];                           /* -    RESERVED.                            @LDA         */
  ...
  struct {
    unsigned char  _psa_cr0esavearea_hw[4]; /* High word save area for high word of */
    unsigned char  _psa_cr0esavearea_lw[4]; /* Low word save area for low word of   */
    } psa_cr0esavearea;
  unsigned char  psarv5e0[112];                           /* -    RESERVED                             @MAC         */
  ...
  unsigned char  psarv6d8[200];                           /* -    RESERVED                             @M3C         */
  struct ecvt * __ptr64 psaecvt;                                 /* Address of ECVT                      @M3A              */
  struct xcvt * __ptr64 psaxcvt;                                 /* Address of XCVT                      @M3A              */
  ...
  union {
    unsigned char  _psarv7e8[4]; /* -          RESERVED FOR SYSTEM TRACE.       @G860PXK */
    unsigned char  _psaff7e8[4]; /* INITIALIZE FIELD PSARV7E8     @ZMC3284               */
    } _psa_union32;
  ...
  unsigned char  psarv818[4];                             /* -     RESERVED                             @PAC        */
  ...
  unsigned char  psarva18[36];                            /* -    RESERVED                             @P4A         */
  ...
  unsigned char  psastak[1112];                           /* -   NORMAL FRR STACK                     @LVC          */
  unsigned char  psarvfd8[40];                            /* -    RESERVED FOR EXPANSION OF            @PJC         */
  // psaend;                                  /* -           END OF PSA            (MDC612)   @G383P9A  */
  };
...
#define flcetea6                                 _psa_union16._psa_struct15._flcetea6
...
#define flcfacl8                                 _psa_union18.flcfacl._flcfacl8
#define flcfacl9                                 _psa_union18.flcfacl._flcfacl9
...
#define flcer0d8                                 _psa_union19._flcer0d8
#define flcmcic                                  _psa_union20._flcmcic
#define flcemcic                                 _psa_union20._flcemcic
#define flcfsa                                   _psa_union21._psa_struct21._flcfsa
#define flcefsa                                  _psa_union21._flcefsa
#define flcfla                                   _psa_union22._flcfla
#define flceemfctrarrayaddr                      _psa_union22._psa_struct22._flceemfctrarrayaddr
#define flceemfctrarraysize                      _psa_union22._psa_struct22._flceemfctrarraysize
#define flceemfexceptioncnt                      _psa_union22._psa_struct22._flceemfexceptioncnt
...
#define psa_workunit_procclassatdisp         _psa_union28._psa_workunit_procclassatdisp
#define psa_workunit_procclassatdisp_byte0 _psa_union28._psa_struct28._psa_workunit_procclassatdisp_byte0
#define psa_workunit_procclassatdisp_byte1 _psa_union28._psa_struct28._psa_workunit_procclassatdisp_byte1
#define psaprocclass                             _psa_union29._psaprocclass
#define psa_bylpar_procclass                 _psa_union29._psa_bylpar_procclass
#define psaprocclass_byte0                     _psa_union29._psa_struct29._psaprocclass_byte0
#define psaprocclass_byte1                     _psa_union29._psa_struct29._psaprocclass_byte1
#define psa_bylpar_procclass_byte0         _psa_union29._psa_struct30._psa_bylpar_procclass_byte0
#define psa_bylpar_procclass_byte1         _psa_union29._psa_struct30._psa_bylpar_procclass_byte1
...
#define psapswsv16                               _psa_union30._psapswsv16
#define psapswsv                                 _psa_union30._psa_struct31._psapswsv
...
#define psa_cr0esavearea_hw                  psa_cr0esavearea._psa_cr0esavearea_hw
#define psa_cr0esavearea_lw                  psa_cr0esavearea._psa_cr0esavearea_lw
#define psadtsav                                 _psa_union31._psadtsav
#define psaff6c0                                 _psa_union31._psaff6c0
...
#define psarv7e8                                 _psa_union32._psarv7e8
#define psaff7e8                                 _psa_union32._psaff7e8
#define psaus2st                                 _psa_union33._psa_struct32._psaus2st
#define psacdsae                                 _psa_union33.psacdsav._psacdsae
#define psacdsaf                                 _psa_union33.psacdsav._psacdsaf
#define psacdsa0                                 _psa_union33.psacdsav._psacdsa0
#define psacdsa1                                 _psa_union33.psacdsav._psacdsa1
...
#define psagsav                                  _psa_union34._psagsav
#define psaff8a8                                 _psa_union34._psaff8a8
...
#define psaslsa                                  _psa_union35._psaslsa
#define psaff950                                 _psa_union35._psaff950
#define psajstsa                                 _psa_union36._psajstsa
#define psaff998                                 _psa_union36._psaff998
#define psaus2nd                                 _psa_union37._psa_struct33._psaus2nd
#define psaslkr0                                 _psa_union37.psaslksa._psaslkr0
#define psaslkr1                                 _psa_union37.psaslksa._psaslkr1
#define psaslkr2                                 _psa_union37.psaslksa._psaslkr2
#define psaslkr3                                 _psa_union37.psaslksa._psaslkr3
#define psaslkr4                                 _psa_union37.psaslksa._psaslkr4
#define psaslkr5                                 _psa_union37.psaslksa._psaslkr5
#define psaslkr6                                 _psa_union37.psaslksa._psaslkr6
#define psaslkr7                                 _psa_union37.psaslksa._psaslkr7
#define psaslkr8                                 _psa_union37.psaslksa._psaslkr8
#define psaslkr9                                 _psa_union37.psaslksa._psaslkr9
#define psaslkra                                 _psa_union37.psaslksa._psaslkra
#define psaslkrb                                 _psa_union37.psaslksa._psaslkrb
#define psaslkrc                                 _psa_union37.psaslksa._psaslkrc
#define psaslkrd                                 _psa_union37.psaslksa._psaslkrd
#define psaslkre                                 _psa_union37.psaslksa._psaslkre
#define psaslkrf                                 _psa_union37.psaslksa._psaslkrf
...
#define psapslk1                        0x40       /* -        HCWPSLK1 lock indicator              @M6A */
#define psapnlk1                        0x20       /* -        HCWPNLK1 lock indicator              @M6A */
#define psaiolk1                        0x10       /* -        HCWIOLK1 lock indicator              @M6A */
#define psapxlk1                        0x08       /* -        HCWPXLK1 lock indicator              @M6A */
#define psadrlk3                        0x04       /* -        HCWDRLK3 lock indicator              @M6A */
...
#define psaalr                          0x80       /* Equivalent to CVTALR                 @LVA          */
  ...
  #pragma pack(reset)
   ...
   #define PSA_HLASM_LENGTH 0x1000
#endif // _TYPE_PSA
 
#ifdef CCSFIXH_VERIFY
  //  Compilation errors for any of the following
  //  declarations mean that the length of the 
  //  C structure does not match the length of the
  //  HLASM DSECT
  static struct { 
     char _lena000[sizeof(PSA)-4096]; // Structure is smaller
     } PSA_a;
  static struct { 
     char _lenb000[4096-sizeof(PSA)];  // Structure is larger
     } PSA_b;
#endif // CCSFIXH_VERIFY
//
// String substitution table used in this conversion
//   #Subst Input String                Output string
 
//        0 <<  long int>>               <<  long long  int>>
//       93 <<___>>                      <<_>>
//        0 <<_;>>                       <<;>>
//        1 <<double         psaend>>    <<// psaend>>
//        2 <<void * __ptr32 _flccvt>>   <<struct cvt * __ptr32 _flccvt>>
//        1 <<void * __ptr32 psalccav>>  <<struct lcca * __ptr32 psalccav>>
//        1 <<void * __ptr32 psatnew>>   <<struct tcb * __ptr32 psatnew>>
//        1 <<void * __ptr32 psatold>>   <<struct tcb * __ptr32 psatold>>
//        1 <<void * __ptr32 psaaold>>   <<struct ascb * __ptr32 psaaold>>
//        1 <<void * __ptr32 psaanew>>   <<struct ascb * __ptr32 psaanew>>
//        1 <<void * __ptr32 psapccav>>  <<struct pcca * __ptr32 psapccav>>
//        1 <<double         psaecvt>>   <<struct ecvt * __ptr64 psaecvt>>
//        1 <<double         psaxcvt>>   <<struct xcvt * __ptr64 psaxcvt>>
#endif // __CCSFIXH_PSA__
